...
let fila, columna, sopaNube, sopaPalabra, sopaDir, userSP, cambioLetra, cebollines = null
let intentos = 0
...
global.db.data.users[m.sender].cebollines = (global.db.data.users[m.sender].cebollines || 0) + cebollines
...
await m.reply(`\`\`\`${emoji} Has ganado ${cebollines} cebollines 🌱!!\`\`\`\n\n*Correcto!! la palabra _"${sopaPalabra}"_ Se encontraba en la dirección _${cambioLetra}_ De la fila _${fila}_ Y Columna _${columna}_*`)
fila = null, columna = null, sopaNube = null, sopaPalabra = null, sopaDir = null, userSP = null, cambioLetra = null
intentos = 0
return
}else{
