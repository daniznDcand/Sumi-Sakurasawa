...
try {
	...
	if (!isNumber(user.Subs)) user.Subs = 0
	if (!('subBotToken' in user)) user.subBotToken = null
	if (!('subBotConnected' in user)) user.subBotConnected = false
	if (!isNumber(user.subBotLastConnect)) user.subBotLastConnect = 0
	if (!isNumber(user.subBotReconnects)) user.subBotReconnects = 0
