        ...
        quoted: {
            get() {
                ...
                if (msg?.selectedButtonId) {
                    ...
                    if (!this._loggedButtons?.has(msg.selectedButtonId)) {
                        this._loggedButtons = this._loggedButtons || new Set();
                        this._loggedButtons.add(msg.selectedButtonId);
                        console.log(`✅ [PARSER] Found selectedButtonId: ${msg.selectedButtonId}`);
                    }
                ...
                if (msg?.selectedId) {
                    ...
                    if (!this._loggedIds?.has(msg.selectedId)) {
                        this._loggedIds = this._loggedIds || new Set();
                        this._loggedIds.add(msg.selectedId);
                        console.log(`✅ [PARSER] Found selectedId: ${msg.selectedId}`);
                    }
                ...
                if (msg?.id) {
                    ...
                    if (!this._loggedGenericIds?.has(msg.id)) {
                        this._loggedGenericIds = this._loggedGenericIds || new Set();
                        this._loggedGenericIds.add(msg.id);
                        console.log(`✅ [PARSER] Found id: ${msg.id}`);
                    }
                    return msg.id
                }
                ...
                if (msg?.selectedDisplayText) {
                    ...
                    if (!this._loggedDisplayText?.has(msg.selectedDisplayText)) {
                        this._loggedDisplayText = this._loggedDisplayText || new Set();
                        this._loggedDisplayText.add(msg.selectedDisplayText);
                        console.log(`✅ [PARSER] Found selectedDisplayText: ${msg.selectedDisplayText}`);
                    }
                ...
                if (msg?.title) {
                    ...
                    if (!this._loggedTitles?.has(msg.title)) {
                        this._loggedTitles = this._loggedTitles || new Set();
                        this._loggedTitles.add(msg.title);
                        console.log(`✅ [PARSER] Found title: ${msg.title}`);
                    }
                    return msg.title
                }
                ...
                if (finalText && isInteractive) {
                   
                    if (!this._loggedFinalTexts?.has(finalText)) {
                        this._loggedFinalTexts = this._loggedFinalTexts || new Set();
                        this._loggedFinalTexts.add(finalText);
                        console.log(`📝 [PARSER] Final text result: "${finalText}"`);
                    }
                }
