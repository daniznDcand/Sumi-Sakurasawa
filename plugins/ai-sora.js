...
💙 *¡Únete al club exclusivo de Hatsune Miku!* (◕‿◕✿)`,
    m);
  }
...
🌱 *Hatsune Miku necesita instrucciones para crear tu video...* 🎥`,
    m);
  }
...
🌱 *Hatsune Miku está trabajando en tu video...* 🎞️`,
    m);
...
🌱 *Hatsune Miku ha terminado tu creación...* 🎥`,
    m);

    await conn.sendFile(m.chat, videoUrl, 'miku-sora-video.mp4',
`╭━━━〔 💙 𝐑𝐄𝐒𝐔𝐋𝐓𝐀𝐃𝐎 𝐒𝐎𝐑𝐀 💙 〕━━━⬣
│ ✅ *Video IA completado*
│
│ 🎬 *Prompt:* ${text}
...
🌱 *¡Disfruta tu video generado por Hatsune Miku!* (◕‿◕✿)
...
🌱 *Hatsune Miku lo sentirá mucho...* (´；ω；\`)
